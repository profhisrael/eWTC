<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primay sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#060c22">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">eWtc Admin </div>
      </a>
