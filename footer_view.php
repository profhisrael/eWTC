      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Services</h4>
            <ul>
              <li><i class="fa fa-angle-right"></i> <a href="#">Training</a></li>
              <li><i class="fa fa-angle-right"></i> <a href="#">Job recruitment</a></li>
              <li><i class="fa fa-angle-right"></i> <a href="#">Marketing</a></li>
              <li><i class="fa fa-angle-right"></i> <a href="#">Courses</a></li>
              <li><i class="fa fa-angle-right"></i> <a href="#">Programmes</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="fa fa-angle-right"></i> <a href="#">About Us</a></i>
              <li><i class="fa fa-angle-right"></i> <a href="#">Contact Us</a></li>
              <li><i class="fa fa-angle-right"></i> <a href="faqs.php">Faqs</a></li>
